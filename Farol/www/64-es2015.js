...
const Spinner = class {
    ...
    getName() {
        const spinnerName = this.name || _config_bb99b659_js__WEBPACK_IMPORTED_MODULE_1__["b"].get('spinner');
    ...
    render() {
        const self = this;
        const mode = Object(_core_13ed1ad7_js__WEBPACK_IMPORTED_MODULE_0__["d"])(self);
