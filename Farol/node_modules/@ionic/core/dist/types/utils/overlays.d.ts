import { ActionSheetOptions, AlertOptions, AnimationBuilder, HTMLIonOverlayElement, IonicAnimation, LoadingOptions, ModalOptions, OverlayInterface, PickerOptions, PopoverOptions, ToastOptions } from '../interface';
export declare type IonicAnimationInterface = (baseEl: any, opts: any) => IonicAnimation;
