...
/* harmony import */ var _services_firebase_connection_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/firebase-connection.service */ "./src/app/services/firebase-connection.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_firebase_connection_service__WEBPACK_IMPORTED_MODULE_13__["FirebaseConnectionService"],
...
/***/ "./src/app/services/firebase-connection.service.ts":
/*!*********************************************************!*\
  !*** ./src/app/services/firebase-connection.service.ts ***!
  \*********************************************************/
/*! exports provided: FirebaseConnectionService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FirebaseConnectionService", function() { return FirebaseConnectionService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FirebaseConnectionService = /** @class */ (function () {
    function FirebaseConnectionService(firestore) {
        this.firestore = firestore;
    }
    FirebaseConnectionService.prototype.read_Students = function () {
        return this.firestore.collection('users').snapshotChanges();
    };
    FirebaseConnectionService.prototype.registerUser = function (value) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            _this.uSerInfoImplements = _this.userDetails();
            console.log(_this.uSerInfoImplements.uid);
        });
    };
    FirebaseConnectionService.prototype.loginUser = function (email, password) {
        return new Promise(function (resolve, reject) {
            firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().signInWithEmailAndPassword(email, password)
                .then(function (res) { return resolve(res); }, function (err) { return reject(err); });
        });
    };
    FirebaseConnectionService.prototype.logoutUser = function () {
        return new Promise(function (resolve, reject) {
    ...
    FirebaseConnectionService.prototype.userDetails = function () {
        return firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
    };
    FirebaseConnectionService.ctorParameters = function () { return [
        { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
    ]; };
    FirebaseConnectionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyBcu0QmFo0eIy5HCD0sMr5UXqOfX5LvQn8",
        authDomain: "com.slumdev.farol",
        databaseURL: "https://farol-cecee.firebaseio.com",
        projectId: "farol-cecee",
        storageBucket: "farol-cecee.appspot.com",
        messagingSenderId: "827662796759"
    }
};
/*
...
module.exports = __webpack_require__(/*! /home/ismaelkofre/Área de Trabalho/Farol/Farol_Language_Training/Farol/src/main.ts */"./src/main.ts");
